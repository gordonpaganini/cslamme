...
namespace Robotics.Intro.Proxy
{
    ...
    public class IntroState : ICloneable, IDssSerializable
    {
        ...
        private Double _drivePowerLeft;
        
        private Double _drivePowerRight;
        ...
        /// </summary>
        [DataMember()]
        public Double DrivePowerLeft
        {
            get
            {
                return this._drivePowerLeft;
            }
            set
            {
                this._drivePowerLeft = value;
            }
        }
        ...
        /// </summary>
        [DataMember()]
        public Double DrivePowerRight
        {
            get
            {
                return this._drivePowerRight;
            }
            set
            {
                this._drivePowerRight = value;
            }
        }
        ...
        public virtual void CopyTo(IDssSerializable target)
        {
            ...
            typedTarget.MoveState = this.MoveState;
            ...
            typedTarget.DrivePowerLeft = this.DrivePowerLeft;
            typedTarget.DrivePowerRight = this.DrivePowerRight;
        ...
        public virtual object Clone()
        {
            ...
            target.MoveState = this.MoveState;
            ...
            target.DrivePowerLeft = this.DrivePowerLeft;
            target.DrivePowerRight = this.DrivePowerRight;
        ...
        {
            writer.Write((System.Int32)MoveState);
            ...
            writer.Write(DrivePowerLeft);

            writer.Write(DrivePowerRight);
        ...
        {
            MoveState = (MoveStates)reader.ReadInt32();
            ...
            DrivePowerLeft = reader.ReadDouble();

            DrivePowerRight = reader.ReadDouble();

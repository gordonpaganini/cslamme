...
#if NET_CF20
[assembly: ServiceDeclaration(DssServiceDeclaration.Transform, SourceAssemblyKey = @"cf.intro.y2006.m08, version=1.8.0.0, culture=neutral, publickeytoken=68f4f6e054690dc8")]
#else
[assembly: ServiceDeclaration(DssServiceDeclaration.Transform, SourceAssemblyKey = @"intro.y2006.m08, version=1.8.0.0, culture=neutral, publickeytoken=68f4f6e054690dc8")]
#endif
#if !URT_MINCLR
...
namespace Dss.Transforms.TransformIntro
{
    ...
    public class Transforms: TransformBase
    {
        ...
        public static object Transform_Robotics_Intro_Proxy_IntroState_TO_Robotics_Intro_IntroState(object transformFrom)
        {
            ...
            target.MoveState = (Robotics.Intro.MoveStates)((System.Int32)from.MoveState);
            ...
            target.DrivePowerLeft = from.DrivePowerLeft;
            target.DrivePowerRight = from.DrivePowerRight;
        ...
        public static object Transform_Robotics_Intro_IntroState_TO_Robotics_Intro_Proxy_IntroState(object transformFrom)
        {
            ...
            target.MoveState = (Robotics.Intro.Proxy.MoveStates)((System.Int32)from.MoveState);
            target.MotorOn = from.MotorOn;
            target.ForwardMovesOnly = from.ForwardMovesOnly;
            target.StopTimeout = from.StopTimeout;
            target.BackUpTimeout = from.BackUpTimeout;

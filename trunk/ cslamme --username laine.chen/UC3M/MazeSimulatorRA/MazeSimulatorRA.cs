...
namespace Cranium.Simulation.Worlds
{
    ...
    public class MazeSimulatorService : DsspServiceBase
    {
        ...
        public const string InitialStateUri = ServicePaths.MountPoint + @"/Apps/UC3M/Config/MazeSimulatorRA.Config.xml";
        ...
        void AddRobot(Vector3 position)
        {
        ...
        private TTPioneer3DX CreateMotorBase(ref Vector3 position)
        {
            ...
            //robotBaseEntity.State.Assets.Mesh = "archos_01.x";   "LegoNXTTribot.bos";

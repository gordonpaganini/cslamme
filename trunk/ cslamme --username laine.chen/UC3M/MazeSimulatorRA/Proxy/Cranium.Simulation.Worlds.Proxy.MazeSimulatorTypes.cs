...
using worlds = Cranium.Simulation.Worlds.Proxy;


namespace Cranium.Simulation.Worlds.Proxy
{
    ...
    /// </summary>
    [DataContract()]
    [XmlRootAttribute("MazeSimulatorState", Namespace="http://www.conscious-robots.com/2007/08/mazesimulatorra.html")]
    public class MazeSimulatorState : ICloneable, IDssSerializable
    {
        ...
        /// <summary>
        /// Copy To Maze Simulator State
        /// </summary>
        public virtual void CopyTo(IDssSerializable target)
        {
            MazeSimulatorState typedTarget = target as MazeSimulatorState;
        ...
        /// <summary>
        /// Clone Maze Simulator State
        /// </summary>
        public virtual object Clone()
        {
            MazeSimulatorState target = new MazeSimulatorState();
    ...
    public class MazeSimulatorOperations : PortSet<Microsoft.Dss.ServiceModel.Dssp.DsspDefaultLookup, Microsoft.Dss.ServiceModel.Dssp.DsspDefaultDrop, Get, Replace>
    {
        ...
        /// </summary>
        public virtual PortSet<MazeSimulatorState,Fault> Get()
        {
        ...
        /// </summary>
        public virtual PortSet<MazeSimulatorState,Fault> Get(Microsoft.Dss.ServiceModel.Dssp.GetRequestType body)
        {
            Get op = new Get();
        ...
        {
            MazeSimulatorState body = new MazeSimulatorState();
        ...
        /// </summary>
        public virtual PortSet<Microsoft.Dss.ServiceModel.Dssp.DefaultReplaceResponseType,Fault> Replace(MazeSimulatorState body)
        {
    ...
    /// </summary>
    [XmlTypeAttribute(IncludeInSchema=false)]
    public class Get : Microsoft.Dss.ServiceModel.Dssp.Get<Microsoft.Dss.ServiceModel.Dssp.GetRequestType, PortSet<MazeSimulatorState, Fault>>
    {
    ...
    /// </summary>
    [XmlTypeAttribute(IncludeInSchema=false)]
    public class Replace : Microsoft.Dss.ServiceModel.Dssp.Replace<MazeSimulatorState, PortSet<Microsoft.Dss.ServiceModel.Dssp.DefaultReplaceResponseType, Fault>>
    {

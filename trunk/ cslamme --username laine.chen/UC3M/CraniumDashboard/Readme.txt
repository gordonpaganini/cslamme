...
The Control Panel service is a version of the Dashboard service 
...
This Control Panel Service provides access to a graphical representation 
...
the MSRS Visual Environment. See the Simulated Sonar service description for details 

...
//
//  $File: SimulatedSonar.cs $ $Revision: update 5 $
//------------------------------------------------------------------------------
...
namespace Cranium.Simulation.Sensors
{
    ...
    public class SimulatedSonar : svcbase.DsspServiceBase
    {
        // Raul - Service Initial state partner file and initially set to null.
        public const string InitialStateUri = ServicePaths.MountPoint + @"/Apps/UC3M/Config/SimulatedSonar.Config.xml";
        ...
        public SimulatedSonar(dssp.DsspServiceCreationPort creationPort) : 
                base(creationPort)
        {
        ...
        private void RaycastResultsHandler(RaycastResult result)
        {
            ...
            // _state.DistanceMeasurement = minDistance;

...
//
//  $File: ExplorerSimSonar.cs $ $Revision: 2 $
...
namespace Microsoft.Robotics.Services.ExplorerSim
{
    ...
    class ExplorerSimSonar : DsspServiceBase
    {
        ...
        /// </summary>
        const int FreeDistance = 500; // mm 3000
...
// A value of 1000 is way too fast in simulation
        ...
        private const string InitialStateUri = ServicePaths.MountPoint + @"/Apps/UC3M/Config/ExplorerSimSonar.Config.xml";
        ...
        void CreateState()
        {
            ...
            _state.MapWidth = 5; // 24;
            _state.MapHeight = 5; // 18;

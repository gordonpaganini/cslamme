...
#if NET_CF20
[assembly: ServiceDeclaration(DssServiceDeclaration.Transform, SourceAssemblyKey = @"cf.simulatedsonar.y2007.m05, version=0.0.0.0, culture=neutral, publickeytoken=afde062daa7bb8cf")]
#else
[assembly: ServiceDeclaration(DssServiceDeclaration.Transform, SourceAssemblyKey = @"simulatedsonar.y2007.m05, version=0.0.0.0, culture=neutral, publickeytoken=afde062daa7bb8cf")]
#endif
#if !URT_MINCLR
...
namespace Dss.Transforms.TransformSimulatedSonar
{

    public class Transforms: TransformBase
    {

        public static object Transform_Cranium_Simulation_Sensors_Proxy_SonarEntity_TO_Cranium_Simulation_Sensors_SonarEntity(object transformFrom)
        {
            Cranium.Simulation.Sensors.SonarEntity target = new Cranium.Simulation.Sensors.SonarEntity();
            Cranium.Simulation.Sensors.Proxy.SonarEntity from = transformFrom as Cranium.Simulation.Sensors.Proxy.SonarEntity;
            target.SonarBox = (from.SonarBox == null) ? null : (Microsoft.Robotics.Simulation.Physics.BoxShape)Transform_Microsoft_Robotics_Simulation_Physics_Proxy_BoxShape_TO_Microsoft_Robotics_Simulation_Physics_BoxShape(from.SonarBox);
        ...
        public static object Transform_Cranium_Simulation_Sensors_SonarEntity_TO_Cranium_Simulation_Sensors_Proxy_SonarEntity(object transformFrom)
        {
            Cranium.Simulation.Sensors.Proxy.SonarEntity target = new Cranium.Simulation.Sensors.Proxy.SonarEntity();
            Cranium.Simulation.Sensors.SonarEntity from = transformFrom as Cranium.Simulation.Sensors.SonarEntity;
            target.SonarBox = (from.SonarBox == null) ? null : (Microsoft.Robotics.Simulation.Physics.Proxy.BoxShape)Transform_Microsoft_Robotics_Simulation_Physics_BoxShape_TO_Microsoft_Robotics_Simulation_Physics_Proxy_BoxShape(from.SonarBox);
        ...
        {
            AddProxyTransform(typeof(Cranium.Simulation.Sensors.Proxy.SonarEntity), Transform_Cranium_Simulation_Sensors_Proxy_SonarEntity_TO_Cranium_Simulation_Sensors_SonarEntity);
            AddSourceTransform(typeof(Cranium.Simulation.Sensors.SonarEntity), Transform_Cranium_Simulation_Sensors_SonarEntity_TO_Cranium_Simulation_Sensors_Proxy_SonarEntity);

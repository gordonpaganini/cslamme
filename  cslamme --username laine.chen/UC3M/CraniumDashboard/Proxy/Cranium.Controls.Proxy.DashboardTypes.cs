...
using controls = Cranium.Controls.Proxy;
using io = System.IO;
using reflection = System.Reflection;


namespace Cranium.Controls.Proxy
{
    ...
    /// </summary>
    [DataContract()]
    [XmlRootAttribute("StateType", Namespace="http://www.conscious-robots.com/2007/09/craniumdashboard.html")]
    ...
    /// </summary>
    [DataContract()]
    [XmlRootAttribute("GUIOptions", Namespace="http://www.conscious-robots.com/2007/09/craniumdashboard.html")]
    public class GUIOptions : ICloneable, IDssSerializable
    {
        ...
        private Int32 _sonarRange;
        
        private Double[] _sonarRadians;
        
        private Single _sonarTransducerAngularRange;
        
        private Boolean _displaySonarMap;
        ...
        /// </summary>
        [DataMember()]
        public Int32 SonarRange
        {
            get
            {
                return this._sonarRange;
            }
            set
            {
                this._sonarRange = value;
            }
        }
        ...
        /// <summary>
        /// Sonar Transducer Angular Range
        /// </summary>
        [DataMember()]
        public Single SonarTransducerAngularRange
        {
            get
            {
                return this._sonarTransducerAngularRange;
            }
            set
            {
                this._sonarTransducerAngularRange = value;
            }
        }
        ...
        /// </summary>
        [DataMember()]
        public Boolean DisplaySonarMap
        {
            get
            {
                return this._displaySonarMap;
            }
            set
            {
                this._displaySonarMap = value;
            }
        }
        ...
        public virtual void CopyTo(IDssSerializable target)
        {
            ...
            typedTarget.SonarRange = this.SonarRange;
            ...
            typedTarget.SonarTransducerAngularRange = this.SonarTransducerAngularRange;
            typedTarget.DisplaySonarMap = this.DisplaySonarMap;
        }
        ...
        public virtual object Clone()
        {
            ...
            target.SonarRange = this.SonarRange;
            ...
            target.SonarTransducerAngularRange = this.SonarTransducerAngularRange;
            target.DisplaySonarMap = this.DisplaySonarMap;
            return target;
        ...
        public virtual void Serialize(System.IO.BinaryWriter writer)
        {
            ...
            writer.Write(SonarTransducerAngularRange);

            writer.Write(DisplaySonarMap);
        ...
        public virtual object Deserialize(System.IO.BinaryReader reader)
        {
            ...
            SonarTransducerAngularRange = reader.ReadSingle();

            DisplaySonarMap = reader.ReadBoolean();

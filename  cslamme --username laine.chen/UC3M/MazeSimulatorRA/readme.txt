...
including installation instructions. Updated for the Version 1.5
release (July 2007).
...
Download the ZIP file and unzip it into your MSRS root directory.
This should create a directory called:
<MSRS>\Apps\QUT\MazeSimulator

NOTE: RA version install dir is: <MSRS>\Apps\UC3M\MazeSimulatorRA

where <MSRS> is the root of your MRS installation, e.g.
C:\Microsoft Robotics Studio (1.5)

You need to recompile all of the services. To do this, open
a MSRS DOS command prompt window. Then enter the command:

RebuildQUTApps

This will rebuild all of the services and copy the contents

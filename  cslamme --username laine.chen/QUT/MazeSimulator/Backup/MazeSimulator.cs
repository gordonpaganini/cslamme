...
namespace Robotics.MazeSimulator
{
    ...
    public class MazeSimulatorService : DsspServiceBase
    {
        ...
        public const string InitialStateUri = ServicePaths.MountPoint + @"/Apps/QUT/Config/MazeSimulator.Config.xml";
        ...
        protected override void Start()
        {
            ...
            if (_state.Maze == null || _state.Maze == "")
                _state.Maze = "Apps/QUT/MazeSimulator/ModelLarge.bmp";

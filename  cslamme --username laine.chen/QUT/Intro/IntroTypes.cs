...
namespace Robotics.Intro
{
    ...
    public class IntroState
    {
        ...
        // TT Jul-2007 - Expose the current state so that it is possible
        // to see what is happening using a web browser
        [DataMember]
        ...
        [DataMember]
        public double DrivePowerLeft = 0;
        [DataMember]
        public double DrivePowerRight = 0;
